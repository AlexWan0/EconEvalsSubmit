...
from exposure_lib.scoring_orig_zsorig import OrigZSOrigArgs, run_orig_zsorig_scoring
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-path",
        default="data/scored_orig_zsorig.pkl",
    ...
    parser.add_argument(
        "--plot-path",
        default="data/scored_orig_zsorig_countplot.png",
...
def main() -> None:
    ...
    scored_df = run_orig_zsorig_scoring(
