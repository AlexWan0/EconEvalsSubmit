...
from exposure_lib.scoring_new_ret import NewRetArgs, run_new_ret_scoring
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Path to retrieved samples DataFrame with category_occ/category_task/convo_subset.",
    )
    parser.add_argument(
        "--task-space-path",
    ...
    parser.add_argument(
        "--task-dwa-path",
        default="",
        help="Optional path to task<->dwa mapping DataFrame with category_occ/category_task/dwa.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--output-path",
        default="data/scored_new_ret.pkl",
    ...
    parser.add_argument(
        "--plot-path",
        default="data/scored_new_ret_countplot.png",
