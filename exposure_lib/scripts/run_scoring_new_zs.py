...
from exposure_lib.scoring_new_zs import NewZSArgs, run_new_zs_scoring
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-path",
        default="data/scored_new_zs.pkl",
    ...
    parser.add_argument(
        "--plot-path",
        default="data/scored_new_zs_countplot.png",
